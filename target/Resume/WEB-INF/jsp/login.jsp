...
<nav class="navbar navbar-dark bg-dark py-0">
    <div class="container">
        <div class="navbar-brand"><h3><img src="resources/images/icon-vacancy.png">    programmer resume  🔥</h3></div>
...
<div class="container lead py-3">
    ...
    Test.<br/>БД хранит актуальные резюме, не старше 45-дневной давности и авто-обновляется из 6-ти ресурсов:<br/>
