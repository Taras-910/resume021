...
import static ua.training.top.util.parser.data.ConstantsUtil.is_age;
...
//                    "кропивницький", "кировоград", "кіровоград", "ua"),
...
//                getJoin(text.substring(0, 1).toUpperCase()).append(text.substring(1)).toString();
//    }
